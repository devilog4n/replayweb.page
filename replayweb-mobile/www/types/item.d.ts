...
declare class Item extends LitElement {
    ...
    renderTabHeader(isSidebar: any): import("lit-html").TemplateResult<1>;
    protected renderToolbarLeft(): import("lit-html").TemplateResult<1>;
    renderLocationBar(): "" | import("lit-html").TemplateResult<1>;
    protected renderToolbarRight(): import("lit-html").TemplateResult<1>;
    private renderTimestamp;
    renderVerifyInfo(): "" | import("lit-html").TemplateResult<1>;
    dragStart(): void;
    dragEnd(): void;
    renderItemInfo(): import("lit-html").TemplateResult<1>;
    renderItemTabs(isSidebar: any): import("lit-html").TemplateResult<1>;
