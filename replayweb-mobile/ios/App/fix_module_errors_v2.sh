...
# Using literal string to avoid shell expanding $(SRCROOT)
cat > xcconfig_additions.txt << 'EOT'
...
# 3. Create a swift bridging file to import UIKit
echo "Creating a unified bridging import file..."
cat > App/UIKitBridge.swift << EOF
// This file imports UIKit for the whole project
@_exported import UIKit
@_exported import WebKit
@_exported import Foundation
EOF

# 4. Force Xcode to recognize the bridging header
echo "Updating bridging header..."
touch App/ReplayWeb-Bridging-Header.h

# 5. Reset simulator to force module cache refresh
echo "Resetting iOS simulator..."
xcrun simctl shutdown all 2>/dev/null || true
xcrun simctl erase all 2>/dev/null || true

# 6. Clear Xcode module cache
